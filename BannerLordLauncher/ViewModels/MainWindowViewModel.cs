...
namespace BannerLordLauncher.ViewModels
{
    ...
    public sealed class MainWindowViewModel : ViewModelBase, IModManagerClient
    {
        ...
        public ICommand ModsFolder { get; }
        ...
        public MainWindowViewModel(MainWindow window)
        {
            ...
            this.ModsFolder = ReactiveCommand.Create(this.OpenModsFolderCmd);
        ...
        private void OpenModsFolderCmd()
        {

            if (this.Manager.OpenModsFolder(out var error)) return;
            if (!string.IsNullOrEmpty(error)) SafeMessage(error);
        }
